...
namespace SheduleManagement.Data
{
    public class ScheduleManagementDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserGroups>().Property(x => x.CreatedTime).ValueGeneratedOnAdd();
       //     modelBuilder.Entity<Events>().HasOne(x => x.Groups).WithMany(x => x.Events).HasForeignKey(x => x.GroupId).OnDelete(DeleteBehavior.ClientSetNull);
